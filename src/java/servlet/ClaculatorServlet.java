...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ClaculatorServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ClaculatorServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
        ...
        if (x != null && x.trim().length() > 0
                && y != null && y.trim().length() > 0
                && y != null && y.trim().length() > 0) {

            Calculator calculator = new Calculator();
            calculator.setX(Double.parseDouble(x));
            calculator.setY(Double.parseDouble(y));
